...
$merah = "\e[91m";
echo "$hijau  ¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤\n";
echo "$hijau  ¤  By      : Agil Dimas Fergiansyah               ¤\n";
echo "$hijau  ¤  Tools   : Perisai Profil Facebook              ¤\n";
echo "$hijau  ¤  Info    : Gunakan Tools Ini Dengan Bijak 😄    ¤\n";
echo "$hijau  ¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤\n";
echo "$input $kuning MASUKAN TOKEN FACEBOOK ANDA ➔➔ : ";
...
if($me && $me->id) {
    ...
    if($hajar->data->is_shielded_set->is_shielded) echo "$merah Status ==> $hijau Sukses silahkan cek profile fb kamu";
    else "GAGAL :( SILAHKAN PERIKSA TOKEN FACEBOOK ANDA";
}
?>
